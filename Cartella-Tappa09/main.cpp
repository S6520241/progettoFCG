...
int main() {
    sf::RenderWindow window(sf::VideoMode({800, 600}), "Space Invaders - Tappa 09");
    ...
    int killScore = 0; // Punti ottenuti dalle eliminazioni
    int totalScore = 0; // Punti totali (Kill + Bonus Tempo)
    int lives = 3;
    ...
    while (window.isOpen()) {
        ...
        if (currentState == GameState::Gameplay) {
            ...
            // Calcolo Punteggio Totale: Kill Score + Bonus tempo (es. 5 punti per ogni secondo vissuto)
